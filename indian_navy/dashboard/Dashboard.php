            ...
            if($this->session->userdata("institution_type")=='IndianNavy'){
                ...
                if($apiData['status'] == "success" && isset($apiData['data'])){
                    ...
                    if($summaryData) {
                        ...
                        $viewdata["total_process_degree"] = $summaryData['Total_Certificate'];
                        $viewdata["total_process_marksheet"] = $summaryData['Total_Marksheet'];
                        $viewdata['stats'][0] = ['ORG_TYPE'=>'IndianNavy'];
                    }else{
                ...
                if($apiData['status'] == "success" && isset($apiData['yearwise_data'])){
                    ...
                    if($yearwiseData) {
                        $viewdata['IndianNavyStats'] = [ 'ORG_TYPE'=>'IndianNavy',
                                                            'total_awards'=> $yearwiseData['Total_Awards'],
                                                            'total_degree'=>$yearwiseData['Total_Certificate'], 
                                                            'total_marksheet'=>$yearwiseData['Total_Marksheet'] ];
                    }
                }
